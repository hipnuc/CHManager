...
/**
 * @brief crc16_update -  generate CRC16
...
uint32_t kptl_create_generic_resp_packet(frame_packet_t *fp, uint32_t status_code,
                                         uint32_t cmd_tag)
{
    uint32_t param[2];
    cmd_hdr_t cp;
...
uint32_t kptl_create_property_resp_packet(frame_packet_t *p, uint8_t param_cnt,
                                          uint32_t *param)
{
    cmd_hdr_t cp;
...
void kptl_create_ping_resp_packet(ping_resp_packet_t *p, uint8_t major, uint8_t minor, uint8_t bugfix,
                                  uint8_t opt_low, uint8_t opt_high)
{
